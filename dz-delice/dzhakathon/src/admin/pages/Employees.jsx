...
const Employees = () => {
  ...
  // Mock employee data - replace with real data from your backend
  ...
  return (
    <div className="flex bg-[#FFFBF8] min-h-screen">
        ...
        <div className="bg-white rounded-lg p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-xl font-semibold text-gray-900">Total Employees : {employees.length}</h2>
            </div>
              ...
              <tbody>
                {filteredEmployees.map((employee) => (
                  <tr key={employee.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-4 px-4">
                      <div className="text-gray-600">{employee.joinDate}</div>
                    </td>
                    <td className="py-4 px-4">
      ...
      {/* Add Employee Modal (Basic Structure) */}
      {showAddEmployee && (
